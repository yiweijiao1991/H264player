...
public:
	...
	{
		return fTimecodeScale;    // in nanoseconds
	}
	float segmentDuration()
	{
		return fSegmentDuration;    // in units of "timecodeScale()"
	}
	...
	{
		return fChosenVideoTrackNumber;
	}
	unsigned chosenAudioTrackNumber()
	{
		return fChosenAudioTrackNumber;
	}
