...
public:
	...
	{
		return fMostRecentPresentationTime;
	}
...
public:
	...
	{
		return fLastFromAddress;
	}
	unsigned lastPacketNumReceived() const
	{
		return fLastPacketNumReceived;
	}
	unsigned firstPacketNumReported() const
	{
		return fFirstPacketNumReported;
	}
	unsigned totNumPacketsLost() const
	{
		return fTotNumPacketsLost;
	}
	...
	struct timeval timeCreated() const
	{
		return fTimeCreated;
	}
	struct timeval lastTimeReceived() const
	{
